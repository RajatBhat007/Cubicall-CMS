...
export class GameEditComponent {
  ...
  constructor(private route: ActivatedRoute, private router: Router, public http: ApiServiceService) {

  
    console.log(this.http.isAttempted)
  ...
  data1 = [
    { label: 'Attempt 2: +5 points' }
  ]
  data2 = [
    { label: 'Attempt 3: -2 points' }
  ]
  data3 = [
    { label: 'Attempt 4: -5 points' }
  ];
  // increaseValueBox1() {
