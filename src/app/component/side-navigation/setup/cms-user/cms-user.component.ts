...
export class CmsUserComponent {
  ...
  createCmsUserOnSubmit(){
    ...
    if (this.EditButton) {
      console.log('hello');
       this.payload = {
        Data: {
          ...
          IdOrganization:this.getEditUserDetails?.idOrganization ? this.getEditUserDetails?.idOrganization:Number(this.selectedOrganizationID),
          ...
          IdCmsRole:this.getEditUserDetails?.idCmsRole ? this.getEditUserDetails?.idCmsRole : Number(this.selectedCmsIdRole), //pass static because get roles api is not working
        },  
      };
      ...
      const escapedIdOrganization= JSON.stringify(this.payload.Data.IdOrganization);
      ...
      const escapedIdOrgHierarchy=JSON.stringify(this.payload.Data.IdOrgHierarchy);
...
// ------------edit Cms user ----------------
  ...
  // );
  // });
  this.selectedDropdownIndustryValue=this.getEditUserDetails?.organizationName;
