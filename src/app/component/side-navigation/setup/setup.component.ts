...
export class SetupComponent implements OnInit {
  ...
  openModal() {
    const modalRef: NgbModalRef = this.modalService.open('#organizationSuccessModal', { ariaLabelledBy: 'exampleModalLabel' });
    // You can also handle modal events using modalRef, if needed
  }
