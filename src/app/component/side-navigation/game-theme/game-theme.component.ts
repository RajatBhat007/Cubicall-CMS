      ...
      this.https
        ...
        .subscribe(
          (res) => {
            ...
            this.openModal('Done! The File has been uploaded successfully.','GameTheme');
          },
  ...
  getStatusValue(event:any,i:any){
    ...
    if (event.currentTarget.checked) {
      ...
      const payload = {
        Data: {
          ...
          QuestionList:{
              ...
              ColumnNo:this.questionListResponse[i]?.rowNo ? this.questionListResponse[i]?.rowNo:0,
              Direction:this.questionListResponse[i]?.direction ?this.questionListResponse[i]?.direction:"across",
      ...
      this.https.editQuestionAns(body).subscribe((res) => {
        ...
        // ); 
        this.openModal('Done! The Question has been Activated successfully.','user');
      ...
      this.https.editQuestionAns(body).subscribe((res) => {
        console.log(res);
        this.openModal('Done! The Question has been Dactivated successfully.','user');
      });
    }
  }
  getCubeFaceGameTime() {
