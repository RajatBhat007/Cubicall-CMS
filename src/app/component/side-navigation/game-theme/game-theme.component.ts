...
export class GameThemeComponent implements OnInit {
  ...
  editGameTime(value:any,label:any){
   if(label=='gametime'){
    ...
    let gamePointsActiveTab=this.activeSubSubTab;
    let cubesFacesGameId = JSON.stringify(this.cubeFaceIdViseGameTimeData[value]);
    ...
    let gamePointsActiveTab=this.activeSubSubTab;
    let cubeFaceGameAttemptEdit = JSON.stringify(this.cubeFaceIdViseGameAttemtData[value]);
    ...
    let gamePointsActiveTab=this.activeSubSubTab;
    let cubeFaceGameStreakEdit = JSON.stringify(this.cubeFaceIdViseGameStreakData[value]);
